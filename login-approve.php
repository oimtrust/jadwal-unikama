...
<div style="margin:auto">
	<form action="auth-approve.php" method="post" style="width:400px; margin:auto;">
		<fieldset>
			<legend>Login Approval</legend>
			<?php
			...
			<?php } else if ($error == 5) {?>
			<div class="error">Anda Bukan Approval</div>
			<?php } ?>
        ...
        <button class="btn waves-effect red waves-light" type="button" Value="Login Page" Onclick="window.location.href='login.php'">Cancel<i class="material-icons right">input</i></button>
      </div>
		</fieldset>
	</form>
<br><br>
